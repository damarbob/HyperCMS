...
<script type="text/javascript">
  ...
  `;
    ...
    // Bulma Footer Block
    editor.Blocks.add('bulma-footer', {
      label: 'Footer',
      category: 'Bulma',
      media: defaultMedia,
      content: `
