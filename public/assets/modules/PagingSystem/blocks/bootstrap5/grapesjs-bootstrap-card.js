grapesjs.plugins.add("grapesjs-bootstrap-card", function (editor, opts = {}) {
    ...
    editor.Components.addType("bs-card", {
        isComponent: (el) => el.classList?.contains('bs-card'),
